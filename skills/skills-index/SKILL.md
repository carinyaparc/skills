...
| design | docs/work/{work-id}/design.md for any work item — epic, story, bug, or spike (review via docs-review) | design.md | discovery | architect | solution.md, backlog.md | design.md |
