...
description: >
  ...
  do next without naming a skill. Routes to product, tasks, tdd, etc.
...
| --- | --- | --- | --- | --- | --- | --- |
| adr | Plan the register — survey product/solution for decisions still to make, or `adr plan <work-id>` to harvest decisions already made in tdd.md — then write or review ADRs | register.md / ADR-NNNN.md | architecture | architect | solution.md, tdd.md | ADR-NNNN.md |
| tasks | Decompose any work item: product/roadmap into epics, an epic into stories and tasks with Gherkin AC, a story into sub-tasks, or any spec/RFC into both. Resolves Linear/Jira/GitHub/filesystem first | backlog.md / tasks.md, or the tracker | strategy / discovery | delivery | product.md, roadmap.md, tdd.md, any spec | backlog.md, tasks.md |
...
| implement | Implements a task against tdd.md and tasks.md, tests included | code | delivery | engineer | tdd.md, tasks.md | code |
| code-review | Code review of a branch, PR, or working diff | code review | delivery | engineer | tdd.md, tasks.md | review |
...
| ralph-loop-setup | Seed and configure a Ralph loop: pick a preset (engineering delivery, ad-hoc, custom), resolve the environment, set the completion promise and iteration budget; never starts the loop | seeded loop | delivery | delivery | tdd.md, tasks.md | loop files |
...
| validate | Work item sign-off vs AC and, for an epic, roadmap gates | validation report | delivery | delivery | backlog.md, tasks.md, solution.md | validation |
